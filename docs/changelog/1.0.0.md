...
The 1.0.0 API freeze. This release finalizes the detector
configuration, descriptor, and low-level surfaces across every
binding layer (Rust, Python, WASM, C) — see *Migration* below for a
